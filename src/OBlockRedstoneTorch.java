...
public class OBlockRedstoneTorch extends OBlockTorch {
    ...
    public int a(int var1, int var2) {
        return var1 == 1 ? OBlock.ax.a(var1, var2) : super.a(var1, var2);
    }

    private boolean a(OWorld var1, int var2, int var3, int var4, boolean var5) {
        if (var5) {
            b.add(new ORedstoneUpdateInfo(var2, var3, var4, var1.n()));
        }
    ...
    public void a(OWorld var1, int var2, int var3, int var4, Random var5) {
        ...
        while (b.size() > 0 && var1.n() - ((ORedstoneUpdateInfo) b.get(0)).d > 100L) {
            b.remove(0);
        }

        if (this.a) {
            if (var6) {
                var1.b(var2, var3, var4, OBlock.aR.bO, var1.c(var2, var3, var4));
            ...
            // CanaryMod: Allow redstone torches to provide power
            int current = (Integer) etc.getLoader().callHook(PluginLoader.Hook.REDSTONE_CHANGE, new Block(var1.world, bO, var2, var3, var4), 0, 1);

            if (current > 0) {
                var1.b(var2, var3, var4, OBlock.aS.bO, var1.c(var2, var3, var4));
            }
        } else {
            counter++;
            if (counter < 5) {
