    ...
    public void a(OWorld var1, int var2, int var3, int var4, Random var5) {
        ...
        if (this.a) {
            if (var6) {
                ...
                int current = (Integer) etc.getLoader().callHook(PluginLoader.Hook.REDSTONE_CHANGE, new Block(var1.world, bA, var2, var3, var4), 1, 0);
                if (current == 0)
            ...
            // CanaryMod: Allow redstone torches to provide power
            int current = (Integer) etc.getLoader().callHook(PluginLoader.Hook.REDSTONE_CHANGE, new Block(var1.world, bA, var2, var3, var4), 0, 1);
            if (current > 0)
