...
public class OBlockRedstoneTorch extends OBlockTorch {
   ...
   private boolean a(OWorld var1, int var2, int var3, int var4, boolean var5) {
      if(var5) {
         cb.add(new ORedstoneUpdateInfo(var2, var3, var4, var1.n()));
      }

      int var6 = 0;

      for(int var7 = 0; var7 < cb.size(); ++var7) {
         ORedstoneUpdateInfo var8 = (ORedstoneUpdateInfo)cb.get(var7);
   ...
   public void a(OWorld var1, int var2, int var3, int var4, Random var5) {
      ...
      while(cb.size() > 0 && var1.n() - ((ORedstoneUpdateInfo)cb.get(0)).d > 100L) {
         cb.remove(0);
      }

      if(this.a) {
         if(var6) {
            var1.b(var2, var3, var4, OBlock.aP.bM, var1.e(var2, var3, var4));
            // CanaryMod: Allow redstone torches to provide power
            int current = (Integer) etc.getLoader().callHook(PluginLoader.Hook.REDSTONE_CHANGE, new Block(var1.world, bL, var2, var3, var4), 1, 0);
            if (current == 0)
          ...
          // CanaryMod: Allow redstone torches to provide power
          int current = (Integer) etc.getLoader().callHook(PluginLoader.Hook.REDSTONE_CHANGE, new Block(var1.world, bL, var2, var3, var4), 0, 1);
          if (current > 0)
        	  var1.b(var2, var3, var4, OBlock.aQ.bM, var1.e(var2, var3, var4));
      } else {
          counter++;
          if (counter < 5)
