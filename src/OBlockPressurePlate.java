...
public class OBlockPressurePlate extends OBlock {
   ...
   public boolean d(OWorld var1, int var2, int var3, int var4) {
      return var1.o(var2, var3 - 1, var4) || var1.a(var2, var3 - 1, var4) == OBlock.aZ.bM;
   }
   ...
   public void a(OWorld var1, int var2, int var3, int var4, int var5) {
      boolean var6 = false;
      if(!var1.o(var2, var3 - 1, var4) && var1.a(var2, var3 - 1, var4) != OBlock.aZ.bM) {
         var6 = true;
      }
   ...
   private void c(OWorld var1, int var2, int var3, int var4) {
      ...
      if (var6 != var5)
          var6 = (Integer) etc.getLoader().callHook(PluginLoader.Hook.REDSTONE_CHANGE, new Block(var1.world, bL, var2, var3, var4), var5 ? 1 : 0, var6 ? 1 : 0) > 0;
