...
public class OChunk {
   ...
   public void b() {
      ...
      for(var2 = 0; var2 < 16; ++var2) {
         for(var3 = 0; var3 < 16; ++var3) {
            ...
            int var5;
            for(var5 = var2 << this.f.b | var3 << this.f.a; var4 > 0 && OBlock.o[this.b[var5 + var4 - 1] & 255] == 0; --var4) {
               ;
            }
            ...
            if(!this.f.y.e) {
               ...
               do {
                  var6 -= OBlock.o[this.b[var5 + var7] & 255];
                  if(var6 > 0) {
   ...
   private void g(int var1, int var2, int var3) {
      ...
      for(int var6 = var1 << this.f.b | var3 << this.f.a; var5 > 0 && OBlock.o[this.b[var6 + var5 - 1] & 255] == 0; --var5) {
         ;
      }
      ...
      if(var5 != var4) {
         ...
         if(!this.f.y.e) {
            ...
            for(var9 = 15; var5 > 0 && var9 > 0; this.h.a(var1, var5, var3, var9)) {
               --var5;
               var10 = OBlock.o[this.a(var1, var5, var3)];
               if(var10 == 0) {
                  var10 = 1;
               }
   ...
   public boolean a(int var1, int var2, int var3, int var4, int var5, boolean checkPortal){
	   byte var6 = (byte)var4;
	      ...
	      if(var9 == var4 && this.g.a(var1, var2, var3) == var5) {
	         ...
	         if(var9 != 0) {
	            if(!this.f.I) {
	               OBlock.k[var9].e(this.f, var10, var2, var11);
	            } else if(OBlock.k[var9] instanceof OBlockContainer) {
	               this.f.m(var10, var2, var11);
	            }
	         }

	         this.g.a(var1, var2, var3, var5);
	         if(!this.f.y.e) {
	            if(OBlock.o[var6 & 255] != 0) {
	               if(var2 >= var8) {
	         ...
	         if(var4 != 0) {
	            if(!this.f.I) {
	               OBlock.k[var4].b(this.f, var10, var2, var11);
	            }

	            if(OBlock.k[var4] instanceof OBlockContainer) {
	               var12 = this.d(var1, var2, var3);
	               if(var12 == null) {
	                  var12 = ((OBlockContainer)OBlock.k[var4]).k_();
	         ...
	         } else if(var9 > 0 && OBlock.k[var9] instanceof OBlockContainer) {
	            var12 = this.d(var1, var2, var3);
	            if(var12 != null) {
	               var12.c();
	            }
   ...
   public boolean a(int var1, int var2, int var3, int var4, boolean checkPortal) {
	      ...
	      if(var8 == var4) {
	         ...
	         if(var8 != 0) {
	            OBlock.k[var8].e(this.f, var9, var2, var10);
	         }

	         this.g.a(var1, var2, var3, 0);
	         if(OBlock.o[var5 & 255] != 0) {
	            if(var2 >= var7) {
	               this.g(var1, var2 + 1, var3);
	            }
	         } else if(var2 == var7 - 1) {
	         ...
	         if(var4 != 0) {
	            if(!this.f.I) {
	               OBlock.k[var4].b(this.f, var9, var2, var10);
	            }

	            if(var4 > 0 && OBlock.k[var4] instanceof OBlockContainer) {
	               var11 = this.d(var1, var2, var3);
	               if(var11 == null) {
	                  var11 = ((OBlockContainer)OBlock.k[var4]).k_();
	         ...
	         } else if(var8 > 0 && OBlock.k[var8] instanceof OBlockContainer) {
	            var11 = this.d(var1, var2, var3);
	            if(var11 != null) {
	               var11.c();
	            }
   ...
   public boolean b(int var1, int var2, int var3, int var4) {
      ...
      if(var5 == var4) {
         ...
         if(var6 > 0 && OBlock.k[var6] instanceof OBlockContainer) {
   ...
   public void a(OEntity var1) {
      ...
      int var4 = OMathHelper.b(var1.ac / 16.0D);
      if(var4 < 0) {
         var4 = 0;
      }
   ...
   public OTileEntity d(int var1, int var2, int var3) {
      ...
      if(var5 == null) {
         ...
         if(var5 == null) {
            var5 = ((OBlockContainer)OBlock.k[var6]).k_();
   ...
   public void a(int var1, int var2, int var3, OTileEntity var4) {
      ...
      if(this.a(var1, var2, var3) != 0 && OBlock.k[this.a(var1, var2, var3)] instanceof OBlockContainer) {
         var4.n();
   ...
   public void a(OEntity var1, OAxisAlignedBB var2, List var3) {
      ...
      for(int var6 = var4; var6 <= var5; ++var6) {
         ...
         for(int var8 = 0; var8 < var7.size(); ++var8) {
            ...
            if(var9 != var1 && var9.al.a(var2)) {
               var3.add(var9);
               OEntity[] var10 = var9.am();
               if(var10 != null) {
   ...
   public void a(Class var1, OAxisAlignedBB var2, List var3) {
      ...
      for(int var6 = var4; var6 <= var5; ++var6) {
         ...
         for(int var8 = 0; var8 < var7.size(); ++var8) {
            OEntity var9 = (OEntity)var7.get(var8);
            if(var1.isAssignableFrom(var9.getClass()) && var9.al.a(var2)) {
               var3.add(var9);
            }
         }
      }
   ...
   public void a(OIChunkProvider var1, OIChunkProvider var2, int var3, int var4) {
      if(!this.p && var1.c(var3 + 1, var4 + 1) && var1.c(var3, var4 + 1) && var1.c(var3 + 1, var4)) {
         var1.a(var2, var3, var4);
      }

      if(var1.c(var3 - 1, var4) && !var1.b(var3 - 1, var4).p && var1.c(var3 - 1, var4 + 1) && var1.c(var3, var4 + 1) && var1.c(var3 - 1, var4 + 1)) {
         var1.a(var2, var3 - 1, var4);
      }

      if(var1.c(var3, var4 - 1) && !var1.b(var3, var4 - 1).p && var1.c(var3 + 1, var4 - 1) && var1.c(var3 + 1, var4 - 1) && var1.c(var3 + 1, var4)) {
         var1.a(var2, var3, var4 - 1);
      }

      if(var1.c(var3 - 1, var4 - 1) && !var1.b(var3 - 1, var4 - 1).p && var1.c(var3, var4 - 1) && var1.c(var3 - 1, var4)) {
   ...
   public int c(int var1, int var2) {
      ...
      if(var4 == -999) {
         ...
         while(var5 > 0 && var4 == -1) {
            ...
            OMaterial var7 = var6 == 0?OMaterial.a:OBlock.k[var6].bZ;
            if(!var7.d() && !var7.a()) {
               --var5;
            } else {
               var4 = var5 + 1;
