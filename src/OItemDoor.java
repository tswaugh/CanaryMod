...
public class OItemDoor extends OItem {
      ...
      if(var7 != 1) {
         ...
         if(var2.d(var4, var5, var6) && var2.d(var4, var5 + 1, var6)) {
            if(!var8.d(var3, var4, var5, var6)) {
               ...
               int var9 = OMathHelper.b((double)((var2.ah + 180.0F) * 4.0F / 360.0F) - 0.5D) & 3;
   ...
   public static void a(OWorld var0, int var1, int var2, int var3, int var4, OBlock var5) {
      ...
      int var8 = (var0.o(var1 - var6, var2, var3 - var7)?1:0) + (var0.o(var1 - var6, var2 + 1, var3 - var7)?1:0);
      int var9 = (var0.o(var1 + var6, var2, var3 + var7)?1:0) + (var0.o(var1 + var6, var2 + 1, var3 + var7)?1:0);
      boolean var10 = var0.a(var1 - var6, var2, var3 - var7) == var5.bM || var0.a(var1 - var6, var2 + 1, var3 - var7) == var5.bM;
      boolean var11 = var0.a(var1 + var6, var2, var3 + var7) == var5.bM || var0.a(var1 + var6, var2 + 1, var3 + var7) == var5.bM;
      boolean var12 = false;
      if(var10 && !var11) {
         var12 = true;
      } else if(var9 > var8) {
      ...
      var0.t = true;
      var0.b(var1, var2, var3, var5.bM, var4);
      var0.b(var1, var2 + 1, var3, var5.bM, var4 + 8);
      var0.t = false;
      var0.h(var1, var2, var3, var5.bM);
      var0.h(var1, var2 + 1, var3, var5.bM);
   }
}
