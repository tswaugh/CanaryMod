...
public class OItemDoor extends OItem {
    ...
    public boolean a(OItemStack var1, OEntityPlayer var2, OWorld var3, int var4, int var5, int var6, int var7) {
        if (var7 != 1) {
            ...
            if (var2.c(var4, var5, var6) && var2.c(var4, var5 + 1, var6)) {
    ...
    public static void a(OWorld var0, int var1, int var2, int var3, int var4, OBlock var5) {
        ...
        var0.t = true;
        var0.b(var1, var2, var3, var5.bA, var4);
        var0.b(var1, var2 + 1, var3, var5.bA, var4 + 8);
        var0.t = false;
        var0.h(var1, var2, var3, var5.bA);
        var0.h(var1, var2 + 1, var3, var5.bA);
    }
}
