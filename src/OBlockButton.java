...
public class OBlockButton extends OBlock {
   ...
   public void d(OWorld var1, int var2, int var3, int var4, int var5) {
      ...
      if(var5 == 2 && var1.d(var2, var3, var4 + 1)) {
         var6 = 4;
      } else if(var5 == 3 && var1.d(var2, var3, var4 - 1)) {
         var6 = 3;
      } else if(var5 == 4 && var1.d(var2 + 1, var3, var4)) {
         var6 = 2;
      } else if(var5 == 5 && var1.d(var2 - 1, var3, var4)) {
         var6 = 1;
      } else {
   ...
   private int g(OWorld var1, int var2, int var3, int var4) {
      return var1.d(var2 - 1, var3, var4)?1:(var1.d(var2 + 1, var3, var4)?2:(var1.d(var2, var3, var4 - 1)?3:(var1.d(var2, var3, var4 + 1)?4:1)));
   }
