...
public class OItemBucket extends OItem {
   ...
   public OItemStack b(OItemStack var1, OWorld var2, OEntityPlayer var3) {
      float var4 = 1.0F;
      double var5 = var3.Y + (var3.ab - var3.Y) * (double)var4;
      double var7 = var3.Z + (var3.ac - var3.Z) * (double)var4 + 1.62D - (double)var3.au;
      double var9 = var3.aa + (var3.ad - var3.aa) * (double)var4;
      ...
      if(var12 == null) {
         ...
         if(var12.a == OEnumMovingObjectType.a) {
            ...
            if(this.a == 0) {
               ...
               if(var2.d(var13, var14, var15) == OMaterial.g && var2.e(var13, var14, var15) == 0) {
               ...
               if(var2.d(var13, var14, var15) == OMaterial.h && var2.e(var13, var14, var15) == 0) {
            	   // Filling a bucket with water!
                   if (var3 instanceof OEntityPlayerMP && (Boolean) etc.getLoader().callHook(PluginLoader.Hook.ITEM_USE, ((OEntityPlayerMP) var3).getPlayer(), blockPlaced, blockClicked, new Item(var1)) && var3.L.d)
                       return var1;
                   var2.e(var13, var14, var15, 0);
               ...
               if(var2.b(var13, var14, var15) || !var2.d(var13, var14, var15).b()) {
                  if(var2.y.d && this.a == OBlock.A.bM) {
