...
public class OBlockNote extends OBlockContainer {
   ...
   public void a(OWorld var1, int var2, int var3, int var4, int var5) {
      if(var5 > 0) {
         boolean var6 = var1.u(var2, var3, var4);
         OTileEntityNote var7 = (OTileEntityNote)var1.l(var2, var3, var4);
   ...
   public boolean a(OWorld var1, int var2, int var3, int var4, OEntityPlayer var5) {
      if(var1.I) {
         ...
         OTileEntityNote var6 = (OTileEntityNote)var1.l(var2, var3, var4);
         if(var6 != null) {
            var6.d();
