...
public class OItemSign extends OItem {
   ...
   public boolean a(OItemStack var1, OEntityPlayer var2, OWorld var3, int var4, int var5, int var6, int var7) {
      if(var7 == 0) {
         return false;
      } else if(!var3.d(var4, var5, var6).b()) {
         return false;
      } else {
         ...
         if(!var2.d(var4, var5, var6)) {
            return false;
         } else if(!OBlock.aD.d(var3, var4, var5, var6)) {
            return false;
         } else {
            ...
            if(var7 == 1) {
               int var8 = OMathHelper.b((double)((var2.ah + 180.0F) * 16.0F / 360.0F) + 0.5D) & 15;
               var3.b(var4, var5, var6, OBlock.aD.bM, var8);
            } else {
               var3.b(var4, var5, var6, OBlock.aI.bM, var7);
            }

            --var1.a;
            OTileEntitySign var9 = (OTileEntitySign)var3.l(var4, var5, var6);
            if(var9 != null) {
               var2.a(var9);
            }
