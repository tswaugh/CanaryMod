...
public class OChunkProviderServer implements OIChunkProvider {
   ...
   public OChunkProviderServer(OWorldServer var1, OIChunkLoader var2, OIChunkProvider var3) {
      super();
      this.c = new OEmptyChunk(var1, new byte[256 * var1.c], 0, 0);
      this.h = var1;
      this.e = var2;
      this.d = var3;
   }
   ...
   public void d(int var1, int var2) {
      if(this.h.y.d()) {
         OChunkCoordinates var3 = this.h.o();
   ...
   public OChunk a(int var1, int var2) {
      ...
      if(var5 == null) {
         ...
         if(var5 != null) {
             ...
             if (!var5.p && this.c(var1 + 1, var2 + 1) && this.c(var1, var2 + 1) && this.c(var1 + 1, var2)) {
                 this.a(this, var1, var2);
             }
         }// To prevent NullPointerExceptions
         if (this.c(var1 - 1, var2) && !this.b(var1 - 1, var2).p && this.c(var1 - 1, var2 + 1) && this.c(var1, var2 + 1) && this.c(var1 - 1, var2)) {
   ...
   public OChunk b(int var1, int var2) {
      ...
      return var3 == null?(!this.h.D && !this.a?this.c:this.a(var1, var2)):var3;
   }
