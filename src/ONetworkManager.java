...
public class ONetworkManager {
   ...
   private boolean g() {
      ...
      try {
         ...
         int var10001;
         int[] var10000;
         if(!this.n.isEmpty() && (this.f == 0 || System.currentTimeMillis() - ((OPacket)this.n.get(0)).l >= (long)this.f)) {
            var2 = this.g;
            synchronized(this.g) {
         ...
         if(this.y-- <= 0 && !this.o.isEmpty() && (this.f == 0 || System.currentTimeMillis() - ((OPacket)this.o.get(0)).l >= (long)this.f)) {
            var2 = this.g;
            synchronized(this.g) {
   ...
   private boolean h() {
      ...
      try {
         OPacket var2 = OPacket.a(this.j, this.p.d());
         if(var2 != null) {
            int[] var10000 = d;
            int var10001 = var2.b();
