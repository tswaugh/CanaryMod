...
public class OExplosion {
   ...
   public void a() {
            ...
            for(var5 = 0; var5 < var2; ++var5) {
               if(var3 == 0 || var3 == var2 - 1 || var4 == 0 || var4 == var2 - 1 || var5 == 0 || var5 == var2 - 1) {
                  ...
                  for(float var21 = 0.3F; var14 > 0.0F; var14 -= var21 * 0.75F) {
                     ...
                     if(var25 > 0) {
                        var14 -= (OBlock.k[var25].a(this.e) + 0.3F) * var21;
                     }
      ...
      for(int var31 = 0; var31 < var29.size(); ++var31) {
         ...
         double var33 = var32.h(this.b, this.c, this.d) / (double)this.f;
         if(var33 <= 1.0D) {
            var15 = var32.ab - this.b;
            var17 = var32.ac - this.c;
            var19 = var32.ad - this.d;
            double var35 = (double)OMathHelper.a(var15 * var15 + var17 * var17 + var19 * var19);
            var15 /= var35;
            var17 /= var35;
            var19 /= var35;
            double var37 = (double)this.i.a(var30, var32.al);
            ...
            var32.ae += var15 * var39;
            var32.af += var17 * var39;
            var32.ag += var19 * var39;
         }
      }
   ...
   public void a(boolean var1) {
      ...
      for(var3 = var2.size() - 1; var3 >= 0; --var3) {
         ...
         if(var8 > 0) {
            OBlock.k[var8].a(this.i, var5, var6, var7, this.i.e(var5, var6, var7), 0.3F, 0);
            this.i.e(var5, var6, var7, 0);
            OBlock.k[var8].g(this.i, var5, var6, var7);
         }
      }
      ...
      if(this.a) {
         for(var3 = var2.size() - 1; var3 >= 0; --var3) {
            ...
            if(var8 == 0 && OBlock.m[var25] && this.h.nextInt(3) == 0) {
               this.i.e(var5, var6, var7, OBlock.ar.bM);
            }
         }
      }
