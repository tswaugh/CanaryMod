...
public class OMinecraftServer implements Runnable, OICommandListener, OIServer {
    ...
    private boolean s() {
        ...
        try {
            ...
            a.log(Level.WARNING, "The exception was: " + var15.toString());
        ...
        this.a(new OSaveConverterAnvil(new File(".")), var6, var9, var13);
        a.info("Done (" + (System.nanoTime() - var4) + "ns)! For help, type \"help\" or \"?\"");
