...
public class OCrashReport {
    ...
    public OCrashReport(String s, Throwable throwable) {
        this.a = s;
        this.b = throwable;
        this.g();
    }
    ...
    private void g() {
        this.a("Minecraft Version", (Callable) (new OCallableMinecraftVersion(this)));
        this.a("Operating System", (Callable) (new OCallableOSInfo(this)));
        this.a("Java Version", (Callable) (new OCallableJavaInfo(this)));
        this.a("Java VM Version", (Callable) (new OCallableJavaInfo2(this)));
        this.a("Memory", (Callable) (new OCallableMemoryInfo(this)));
        this.a("JVM Flags", (Callable) (new OCallableJVMFlags(this)));
        this.a("AABB Pool Size", (Callable) (new OCallableAABBPoolSize(this)));
    }
