...
public class OItemHoe extends OItem {
   ...
   public boolean a(OItemStack var1, OEntityPlayer var2, OWorld var3, int var4, int var5, int var6, int var7) {
      if(!var2.c(var4, var5, var6)) {
         ...
         if((var7 == 0 || var9 != 0 || var8 != OBlock.v.bA) && var8 != OBlock.w.bA) {
            return false;
         } else {
            // CanaryMod: Hoes
            ...
            var3.a((double)((float)var4 + 0.5F), (double)((float)var5 + 0.5F), (double)((float)var6 + 0.5F), var10.bL.c(), (var10.bL.a() + 1.0F) / 2.0F, var10.bL.b() * 0.8F);
            if(var3.I) {
               return true;
            } else {
               var3.e(var4, var5, var6, var10.bA);
               var1.a(1, var2);
               return true;
            }
         }
