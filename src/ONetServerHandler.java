...
public class ONetServerHandler extends ONetHandler implements OICommandListener {
   ...
   public void a(OPacket10Flying var1) {
      ...
      if(!this.e.j) {
         ...
         if(this.p) {
            ...
            double var15;
            if(this.e.W != null) {
               float var5 = this.e.ah;
               float var6 = this.e.ai;
               this.e.W.ag();
               var7 = this.e.ab;
               var9 = this.e.ac;
               var11 = this.e.ad;
            ...
            if(this.e.L()) {
               this.e.a(true);
               this.e.b(this.m, this.n, this.o, this.e.ah, this.e.ai);
               var2.g(this.e);
               return;
            }
            ...
            var9 = this.e.ac;
            var11 = this.e.ad;
            float var17 = this.e.ah;
            float var18 = this.e.ai;
            if(var1.h && var1.b == -999.0D && var1.d == -999.0D) {
               var1.h = false;
            }
            ...
            var15 = var7 - this.e.ab;
            double var19 = var9 - this.e.ac;
            double var21 = var11 - this.e.ad;
            ...
            float var25 = 0.0625F;
            boolean var26 = var2.a(this.e, this.e.al.b().e((double)var25, (double)var25, (double)var25)).size() == 0;
            if(this.e.am && !var1.g && var19 > 0.0D) {
               this.e.c(0.2F);
            }

            this.e.a(var15, var19, var21);
            this.e.am = var1.g;
            this.e.d(var15, var19, var21);
            double var27 = var19;
            var15 = var7 - this.e.ab;
            var19 = var9 - this.e.ac;
            if(var19 > -0.5D || var19 < 0.5D) {
               var19 = 0.0D;
            }

            var21 = var11 - this.e.ad;
            var23 = var15 * var15 + var19 * var19 + var21 * var21;
            boolean var29 = false;
            if(var23 > 0.0625D && !this.e.L() && !this.e.c.b()) {
               var29 = true;
               a.warning(this.e.v + " moved wrongly!");
               System.out.println("Got position " + var7 + ", " + var9 + ", " + var11);
               System.out.println("Expected " + this.e.ab + ", " + this.e.ac + ", " + this.e.ad);
            }

            this.e.b(var7, var9, var11, var17, var18);
            boolean var30 = var2.a(this.e, this.e.al.b().e((double)var25, (double)var25, (double)var25)).size() == 0;
            if(var26 && (var29 || !var30) && !this.e.L()) {
               this.a(this.m, this.n, this.o, var17, var18);
               return;
            }

            OAxisAlignedBB var31 = this.e.al.b().b((double)var25, (double)var25, (double)var25).a(0.0D, -0.55D, 0.0D);
            ...
            this.e.am = var1.g;
            this.d.h.d(this.e);
            this.e.b(this.e.ac - var3, var1.g);
         }
   ...
   public void a(OPacket14BlockDig var1) {
      ...
      if(var1.e == 4) {
         ...
         int var7 = var1.c;
         if(var4) {
            double var8 = this.e.ab - ((double)var5 + 0.5D);
            double var10 = this.e.ac - ((double)var6 + 0.5D) + 1.5D;
            double var12 = this.e.ad - ((double)var7 + 0.5D);
   ...
   public void a(OPacket15Place var1) {
      ...
      if(var3 == null || var3.l() == 0) {
         ...
         this.e.m.a();
         this.e.h = false;
         if(!OItemStack.a(this.e.k.a(), var1.e)) {
            this.b((OPacket)(new OPacket103SetSlot(this.e.m.f, var12.c, this.e.k.a())));
         }
      }
   ...
   public void a(OPacket16BlockItemSwitch var1) {
      if(var1.a >= 0 && var1.a < OInventoryPlayer.b()) {
         this.e.k.c = var1.a;
      } else {
   ...
   public void a(OPacket7UseEntity var1) {
      ...
      if(var3 != null && this.e.i(var3) && this.e.h(var3) < 36.0D) {
         if(var1.c == 0) {
            this.e.d(var3);
         } else if(var1.c == 1) {
            this.e.e(var3);
      ...
      if(this.e.m.f == var1.a && this.e.m.c(this.e)) {
         ...
         if(OItemStack.a(var1.e, var2)) {
            ...
            for(int var4 = 0; var4 < this.e.m.e.size(); ++var4) {
               var3.add(((OSlot)this.e.m.e.get(var4)).a());
            }
   ...
   public void a(OPacket107CreativeSetSlot var1) {
      if(this.e.c.b()) {
         ...
         boolean var4 = var1.a >= 36 && var1.a < 36 + OInventoryPlayer.b();
   ...
   public void a(OPacket130UpdateSign var1) {
      OWorldServer var2 = this.d.a(this.e.w);
      if(var2.c(var1.a, var1.b, var1.c)) {
         OTileEntity var3 = var2.l(var1.a, var1.b, var1.c);
