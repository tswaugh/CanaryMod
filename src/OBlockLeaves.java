...
public class OBlockLeaves extends OBlockLeavesBase {
   ...
   public void a(OWorld var1, int var2, int var3, int var4, Random var5) {
      if(!var1.I) {
         ...
         if((var6 & 8) != 0 && (var6 & 4) == 0) {
            ...
            int var11 = var9 / 2;
            if(this.cb == null) {
               this.cb = new int[var9 * var9 * var9];
            }
               ...
               for(var12 = -var7; var12 <= var7; ++var12) {
                  for(var13 = -var7; var13 <= var7; ++var13) {
                     for(var14 = -var7; var14 <= var7; ++var14) {
                        ...
                        if(var15 == OBlock.J.bM) {
                           this.cb[(var12 + var11) * var10 + (var13 + var11) * var9 + var14 + var11] = 0;
                        } else if(var15 == OBlock.K.bM) {
                           this.cb[(var12 + var11) * var10 + (var13 + var11) * var9 + var14 + var11] = -2;
                        } else {
                           this.cb[(var12 + var11) * var10 + (var13 + var11) * var9 + var14 + var11] = -1;
                        }
                     }
                  }
               }
                  ...
                  for(var13 = -var7; var13 <= var7; ++var13) {
                     for(var14 = -var7; var14 <= var7; ++var14) {
                        for(var15 = -var7; var15 <= var7; ++var15) {
                           if(this.cb[(var13 + var11) * var10 + (var14 + var11) * var9 + var15 + var11] == var12 - 1) {
                              if(this.cb[(var13 + var11 - 1) * var10 + (var14 + var11) * var9 + var15 + var11] == -2) {
                                 this.cb[(var13 + var11 - 1) * var10 + (var14 + var11) * var9 + var15 + var11] = var12;
                              }
                              ...
                              if(this.cb[(var13 + var11) * var10 + (var14 + var11 - 1) * var9 + var15 + var11] == -2) {
                                 this.cb[(var13 + var11) * var10 + (var14 + var11 - 1) * var9 + var15 + var11] = var12;
                              }
                              ...
                              if(this.cb[(var13 + var11) * var10 + (var14 + var11) * var9 + (var15 + var11 - 1)] == -2) {
                                 this.cb[(var13 + var11) * var10 + (var14 + var11) * var9 + (var15 + var11 - 1)] = var12;
                              }
            ...
            var12 = this.cb[var11 * var10 + var11 * var9 + var11];
            if(var12 >= 0) {
   ...
   public void a(OWorld var1, OEntityPlayer var2, int var3, int var4, int var5, int var6) {
      if(!var1.I && var2.G() != null && var2.G().c == OItem.bd.bM) {
         var2.a(OStatList.C[this.bM], 1);
         this.a(var1, var3, var4, var5, new OItemStack(OBlock.K.bM, 1, var6 & 3));
      } else {
   ...
   public int a(int var1, int var2) {
      return (var2 & 3) == 1?this.bL + 80:this.bL;
   }
