...
public class OBlockDispenser extends OBlockContainer {
   ...
   private void b(OWorld var1, int var2, int var3, int var4, Random var5) {
      ...
      if(var9 != null) {
         ...
         //Canarymod onDispense item and hook
         Item item = new Item();
         if(var10 == null)
          item.setItemId(0);
         else
          item = new Item(var10.c, 1);
         
         if((Boolean) etc.getLoader().callHook(PluginLoader.Hook.DISPENSE, block, item)){
               return;  
             }
         if(var10 == null) {
